...
Partial Public Class LINQ_CERDataContext
  ...
  Partial Private Sub DeleteCER_DRUG_IMPORT(instance As CER_DRUG_IMPORT)
    End Sub
  Partial Private Sub InsertCER_DRUG_IMPORT_PRODUCT(instance As CER_DRUG_IMPORT_PRODUCT)
    End Sub
  Partial Private Sub UpdateCER_DRUG_IMPORT_PRODUCT(instance As CER_DRUG_IMPORT_PRODUCT)
    End Sub
  Partial Private Sub DeleteCER_DRUG_IMPORT_PRODUCT(instance As CER_DRUG_IMPORT_PRODUCT)
    End Sub
  ...
  #End Region
	...
	Public ReadOnly Property CER_DRUG_IMPORT_PRODUCTs() As System.Data.Linq.Table(Of CER_DRUG_IMPORT_PRODUCT)
		Get
			Return Me.GetTable(Of CER_DRUG_IMPORT_PRODUCT)
		End Get
	End Property
...
<Global.System.Data.Linq.Mapping.TableAttribute(Name:="dbo.CER_DRUG_IMPORT_PRODUCT")>  _
Partial Public Class CER_DRUG_IMPORT_PRODUCT
	Implements System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	...
	Private _MANU_NAME As String
	
	Private _MANU_COUNTRY As String
	
	Private _AMOUNT As System.Nullable(Of Integer)
	
	Private _DRUG_UNIT As String
    ...
    End Sub
    Partial Private Sub OnMANU_NAMEChanging(value As String)
    End Sub
    Partial Private Sub OnMANU_NAMEChanged()
    End Sub
    Partial Private Sub OnMANU_COUNTRYChanging(value As String)
    End Sub
    Partial Private Sub OnMANU_COUNTRYChanged()
    End Sub
    Partial Private Sub OnAMOUNTChanging(value As System.Nullable(Of Integer))
    End Sub
    Partial Private Sub OnAMOUNTChanged()
    End Sub
    Partial Private Sub OnDRUG_UNITChanging(value As String)
    End Sub
    Partial Private Sub OnDRUG_UNITChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_REGIS_NO", DbType:="NVarChar(50)")>  _
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_MANU_NAME", DbType:="NVarChar(MAX)")>  _
	Public Property MANU_NAME() As String
		Get
			Return Me._MANU_NAME
		End Get
		Set
			If (String.Equals(Me._MANU_NAME, value) = false) Then
				Me.OnMANU_NAMEChanging(value)
				Me.SendPropertyChanging
				Me._MANU_NAME = value
				Me.SendPropertyChanged("MANU_NAME")
				Me.OnMANU_NAMEChanged
			End If
		End Set
	End Property
	
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_MANU_COUNTRY", DbType:="NVarChar(MAX)")>  _
	Public Property MANU_COUNTRY() As String
		Get
			Return Me._MANU_COUNTRY
		End Get
		Set
			If (String.Equals(Me._MANU_COUNTRY, value) = false) Then
				Me.OnMANU_COUNTRYChanging(value)
				Me.SendPropertyChanging
				Me._MANU_COUNTRY = value
				Me.SendPropertyChanged("MANU_COUNTRY")
				Me.OnMANU_COUNTRYChanged
			End If
		End Set
	End Property
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_DRUG_UNIT", DbType:="NVarChar(50)")>  _
	Public Property DRUG_UNIT() As String
		Get
			Return Me._DRUG_UNIT
		End Get
		Set
			If (String.Equals(Me._DRUG_UNIT, value) = false) Then
				Me.OnDRUG_UNITChanging(value)
				Me.SendPropertyChanging
				Me._DRUG_UNIT = value
				Me.SendPropertyChanged("DRUG_UNIT")
				Me.OnDRUG_UNITChanged
			End If
		End Set
	End Property
